...
set output "N_100_new32_prior/boxplot_kldiv_k_10.eps" 
...
plot  "N_100_new32_prior/k_10_e_0.1/kldivs" using ((1)-3*d_width):1 lt 1 lc rgb "red", \
      ...
      "N_100_new32_prior/k_10_e_0.5/kldivs" using ((2)-3*d_width):1 lt 1 lc rgb "red", \
      "N_100_new32_prior/k_10_e_0.5/kldivs" using ((2)-d_width):2 lt 1 lc rgb "blue", \
      "N_100_new32_prior/k_10_e_0.5/kldivs" using ((2)+d_width):3 lt 1 lc rgb "dark-green", \
      "N_100_new32_prior/k_10_e_0.5/kldivs" using ((2)+3*d_width):4 lt 1 lc rgb "black", \
      "N_100_new32_prior/k_10_e_0.9/kldivs" using ((3)-3*d_width):1 lt 1 lc rgb "red", \
      "N_100_new32_prior/k_10_e_0.9/kldivs" using ((3)-d_width):2 lt 1 lc rgb "blue", \
      "N_100_new32_prior/k_10_e_0.9/kldivs" using ((3)+d_width):3 lt 1 lc rgb "dark-green", \
      "N_100_new32_prior/k_10_e_0.9/kldivs" using ((3)+3*d_width):4 lt 1 lc rgb "black"
